# Scrapy settings for Scrapy_CQC_NYDL_SNCY_tianjinbm project
#
...
BOT_NAME = 'Scrapy_CQC_NYDL_SNCY_tianjinbm'

SPIDER_MODULES = ['Scrapy_CQC_NYDL_SNCY_tianjinbm.spiders']
NEWSPIDER_MODULE = 'Scrapy_CQC_NYDL_SNCY_tianjinbm.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_CQC_NYDL_SNCY_tianjinbm.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_CQC_NYDL_SNCY_tianjinbm.pipelines.MongoDBPipeline': 300,
}
