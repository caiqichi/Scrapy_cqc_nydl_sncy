# Scrapy settings for Scrapy_NYDL_SNCY_qinghai project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_qinghai'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_qinghai.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_qinghai.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_qinghai.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_qinghai.pipelines.MongoDBPipeline': 300,
}
