# Scrapy settings for Scrapy_NYDL_SNCY_jiling project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_jiling'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_jiling.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_jiling.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_jiling.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_jiling.pipelines.MongoDBPipeline': 300,
}
