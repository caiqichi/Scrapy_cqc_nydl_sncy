# Scrapy settings for Scrapy_NYDL_SNCY_nmg project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_nmg'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_nmg.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_nmg.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_nmg.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_nmg.pipelines.MongoDBPipeline': 300,
}
