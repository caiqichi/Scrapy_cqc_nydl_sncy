# Scrapy settings for Scrapy_NYDL_SNCY_guizhou project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_guizhou'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_guizhou.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_guizhou.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_guizhou.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_guizhou.pipelines.MongoDBPipeline': 300,
}
