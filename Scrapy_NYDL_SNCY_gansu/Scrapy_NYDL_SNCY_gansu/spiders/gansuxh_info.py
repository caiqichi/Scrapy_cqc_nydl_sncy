from Scrapy_NYDL_SNCY_gansu import upload_replace as ur
from Scrapy_NYDL_SNCY_gansu.pipelines import MongoDBPipeline
from Scrapy_NYDL_SNCY_gansu.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class GansuxhInfoSpider(scrapy.Spider):
    name = 'gansuxh_info'
    # allowed_domains = ['w']
    start_urls = ['http://www.gsslxh.com/html/1//xiehuidongtai/xiehuidongtai160/index.html',
                  "http://www.gsslxh.com/html/1//xingyeyaowen/xingyedongtai/index.html",
                  "http://www.gsslxh.com/html/1//falvfagui/index.html"]
    web_name = '甘肃省水利工程行业协会'  # 网站名称
    category = '能源电力'  # 模块
    ...
    def parse(self, response):
        ...
        #     next_page = "http://www.gsslxh.com/html/1//xiehuidongtai/xiehuidongtai160/list-{0}.html".format(num)
        #     yield scrapy.Request(url=next_page, callback=self.parse)
        # for num1 in range(2,8):
        #     next_page1 = "http://www.gsslxh.com/html/1//xingyeyaowen/list-{0}.html".format(num1)
        #     yield scrapy.Request(url=next_page1, callback=self.parse)
        # for num2 in range(2,4):
        #     next_page2 = "http://www.gsslxh.com/html/1//falvfagui/list-{0}.html".format(num2)
    ...
    def detail_parse(self, response):
        ...
        # 处理图片的通用格式:
        _xpath1 = '//td[@class="n_all"]//img/@src'  # 改下xpath即可
        ...
        if "falvfagui" in item["content_url"]:
...
if __name__ == '__main__':
    os.system('scrapy crawl gansuxh_info')  ##改下爬虫名
