# Scrapy settings for Scrapy_NYDL_SNCY_gansu project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_gansu'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_gansu.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_gansu.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_gansu.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_gansu.pipelines.MongoDBPipeline': 300,
}
