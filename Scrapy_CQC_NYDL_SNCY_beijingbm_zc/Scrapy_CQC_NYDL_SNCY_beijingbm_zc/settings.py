# Scrapy settings for Scrapy_CQC_NYDL_SNCY_beijingbm_zc project
#
...
BOT_NAME = 'Scrapy_CQC_NYDL_SNCY_beijingbm_zc'

SPIDER_MODULES = ['Scrapy_CQC_NYDL_SNCY_beijingbm_zc.spiders']
NEWSPIDER_MODULE = 'Scrapy_CQC_NYDL_SNCY_beijingbm_zc.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_CQC_NYDL_SNCY_beijingbm_zc.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_CQC_NYDL_SNCY_beijingbm_zc.pipelines.MongoDBPipeline': 300,
}
