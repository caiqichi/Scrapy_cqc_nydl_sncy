# Scrapy settings for Scrapy_NYDL_SNCY_jiangsu project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_jiangsu'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_jiangsu.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_jiangsu.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_jiangsu.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_jiangsu.pipelines.MongoDBPipeline': 300,
}
