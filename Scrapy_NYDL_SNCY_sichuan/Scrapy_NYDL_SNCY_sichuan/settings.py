# Scrapy settings for Scrapy_NYDL_SNCY_sichuan project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_sichuan'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_sichuan.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_sichuan.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_sichuan.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_sichuan.pipelines.MongoDBPipeline': 300,
}
