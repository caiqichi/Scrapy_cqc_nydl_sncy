...
class ChinabmxhInfoSpider(scrapy.Spider):
    ...
    def parse(self, response):
        li_list = response.xpath('//div[@class="slnewscon autoHeight"]//li')
        ...
        #     next_page = "http://www.mwr.gov.cn/zw/zcfg/bmgz/index_{0}.html".format(num)
        #     yield scrapy.Request(url=next_page, callback=self.parse)
        # for num1 in range(1, 10):
        #     next_page1 = "http://www.mwr.gov.cn/zw/zcfg/gfxwj/index_{0}.html".format(num1)
    ...
    def detail_parse(self, response):
        ...
        # 固定模式，改下xpath即可
        content = response.xpath('//div[@class="mainc"] | //div[@class="center_block section"]').extract()
