# Scrapy settings for Scrapy_NYDL_SNCY_chinabm project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_chinabm'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_chinabm.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_chinabm.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_chinabm.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_chinabm.pipelines.MongoDBPipeline': 300,
}
