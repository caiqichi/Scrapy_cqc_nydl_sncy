# Scrapy settings for Scrapy_NYDL_SNCY_shandong project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_shandong'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_shandong.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_shandong.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_shandong.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_shandong.pipelines.MongoDBPipeline': 300,
}
