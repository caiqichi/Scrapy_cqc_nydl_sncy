...
class JiangxixhInfoSpider(scrapy.Spider):
    name = 'jiangxixh_info'
    # allowed_domains = ['w']
    start_urls = ['http://www.jxslsd.org.cn/home/news/index.html',
                  "http://www.jxslsd.org.cn/home/news/index/type/2.html",
                  ]
    ...
    def parse(self, response):
        ...
        #     next_page = "http://www.jxslsd.org.cn/home/news/index/type/21/page/{0}.html".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl jiangxixh_info')  ##改下爬虫名
