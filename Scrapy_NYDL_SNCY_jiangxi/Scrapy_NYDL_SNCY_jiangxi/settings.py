# Scrapy settings for Scrapy_NYDL_SNCY_jiangxi project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_jiangxi'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_jiangxi.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_jiangxi.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_jiangxi.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_jiangxi.pipelines.MongoDBPipeline': 300,
}
