...
class GuangdongxhZcSpider(scrapy.Spider):
    name = 'guangdongxh_zc'
    # allowed_domains = ['w']
    start_urls = ["http://www.gdwha.org/Policy/guojiazhengce.html",
                  'http://www.gdwha.org/Policy/falvfagui.html',
                  ]
    ...
    def parse(self, response):
        ...
        #     next_page = "http://www.gdwha.org/Policy/guojiazhengce_{0}.html".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl guangdongxh_zc')  ##改下爬虫名
