# Scrapy settings for Scrapy_NYDL_SNCY_guangdong project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_guangdong'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_guangdong.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_guangdong.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_guangdong.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_guangdong.pipelines.MongoDBPipeline': 300,
}
