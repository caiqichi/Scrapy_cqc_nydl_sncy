...
class ShanghaixhZcSpider(scrapy.Spider):
    name = 'shanghaixh_zc'
    # allowed_domains = ['w']
    start_urls = ['http://www.swea.com.cn/info.php?class_id=106101',
                  'http://www.swea.com.cn/info.php?class_id=106102',
                  ]
...
if __name__ == '__main__':
    os.system('scrapy crawl shanghaixh_zc')  ##改下爬虫名
