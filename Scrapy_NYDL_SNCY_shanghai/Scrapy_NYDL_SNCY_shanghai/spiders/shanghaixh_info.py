from Scrapy_NYDL_SNCY_shanghai import upload_replace as ur
from Scrapy_NYDL_SNCY_shanghai.pipelines import MongoDBPipeline
from Scrapy_NYDL_SNCY_shanghai.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class ShanghaixhInfoSpider(scrapy.Spider):
    name = 'shanghaixh_info'
    # allowed_domains = ['w']
    start_urls = ['http://www.swea.com.cn/info.php?class_id=103102',
                  'http://www.swea.com.cn/info.php?class_id=103103',
                  'http://www.swea.com.cn/info.php?class_id=103104',
                  ]
    web_name = '上海市水利工程协会'  # 网站名称
    category = '能源电力'  # 模块
    ...
    def parse(self, response):
        li_list = response.xpath('//div[@class="main"]/ul[@class="list"]/li')
        ...
        #     next_page = "http://www.swea.com.cn/info.php?class_id=103102&page={0}".format(num)
        #     yield scrapy.Request(url=next_page, callback=self.parse)
        #
        # for num1 in range(2, 22):
        #     next_page1 = "http://www.swea.com.cn/info.php?class_id=103103&page={0}".format(num1)
        #     yield scrapy.Request(url=next_page1, callback=self.parse)
        #
        # for num2 in range(2, 18):
        #     next_page2 = "http://www.swea.com.cn/info.php?class_id=103104&page={0}".format(num2)
    ...
    def detail_parse(self, response):
        ...
        # 处理图片的通用格式:
        _xpath1 = '//div[@class="bd"]//img/@src'  # 改下xpath即可
...
if __name__ == '__main__':
    os.system('scrapy crawl shanghaixh_info')  ##改下爬虫名
