# Scrapy settings for Scrapy_NYDL_SNCY_shanghai project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_shanghai'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_shanghai.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_shanghai.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_shanghai.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_shanghai.pipelines.MongoDBPipeline': 300,
}
