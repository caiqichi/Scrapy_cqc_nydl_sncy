# Scrapy settings for Scrapy_NYDL_SNCY_liaoning project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_liaoning'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_liaoning.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_liaoning.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_liaoning.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_liaoning.pipelines.MongoDBPipeline': 300,
}
