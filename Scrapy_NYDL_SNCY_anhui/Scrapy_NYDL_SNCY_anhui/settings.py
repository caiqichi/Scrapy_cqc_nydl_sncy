# Scrapy settings for Scrapy_NYDL_SNCY_anhui project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_anhui'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_anhui.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_anhui.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_anhui.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_anhui.pipelines.MongoDBPipeline': 300,
}
