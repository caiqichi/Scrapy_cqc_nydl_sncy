# Scrapy settings for Scrapy_NYDL_SNCY_beijing project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_beijing'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_beijing.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_beijing.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_beijing.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_beijing.pipelines.MongoDBPipeline': 300,
}
