# Scrapy settings for Scrapy_NYDL_SNCY_zhejiang project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_zhejiang'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_zhejiang.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_zhejiang.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_zhejiang.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_zhejiang.pipelines.MongoDBPipeline': 300,
}
