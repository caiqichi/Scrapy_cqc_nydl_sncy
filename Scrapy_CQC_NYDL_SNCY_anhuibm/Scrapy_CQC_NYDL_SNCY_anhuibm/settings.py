# Scrapy settings for Scrapy_CQC_NYDL_SNCY_anhuibm project
#
...
BOT_NAME = 'Scrapy_CQC_NYDL_SNCY_anhuibm'

SPIDER_MODULES = ['Scrapy_CQC_NYDL_SNCY_anhuibm.spiders']
NEWSPIDER_MODULE = 'Scrapy_CQC_NYDL_SNCY_anhuibm.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_CQC_NYDL_SNCY_anhuibm.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_CQC_NYDL_SNCY_anhuibm.pipelines.MongoDBPipeline': 300,
}
