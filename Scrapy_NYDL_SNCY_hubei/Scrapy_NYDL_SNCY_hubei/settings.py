# Scrapy settings for Scrapy_NYDL_SNCY_hubei project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_hubei'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_hubei.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_hubei.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_hubei.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_hubei.pipelines.MongoDBPipeline': 300,
}
