# Scrapy settings for Scrapy_NYDL_SNCY_chongqing project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_chongqing'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_chongqing.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_chongqing.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_chongqing.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_chongqing.pipelines.MongoDBPipeline': 300,
}
