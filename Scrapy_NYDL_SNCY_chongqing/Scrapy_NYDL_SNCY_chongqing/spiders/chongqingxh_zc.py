...
class ChongqingxhZcSpider(scrapy.Spider):
    name = 'chongqingxh_zc'
    # allowed_domains = ['w']
    start_urls = ['http://www.cqwater.net/zen_ce/8.html',
                  ]
    ...
    def parse(self, response):
        li_list = response.xpath('//div[@class="news-content"]/ul[@class="proceedings-main"]/li')
        ...
        #     next_page = "http://www.cqwater.net/zen_ce/8.html?page={0}".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl chongqingxh_zc')  ##改下爬虫名
