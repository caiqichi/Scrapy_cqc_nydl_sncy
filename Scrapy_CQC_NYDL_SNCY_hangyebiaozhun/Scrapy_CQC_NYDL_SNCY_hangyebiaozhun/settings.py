# Scrapy settings for Scrapy_CQC_NYDL_SNCY_hangyebiaozhun project
#
...
BOT_NAME = 'Scrapy_CQC_NYDL_SNCY_hangyebiaozhun'

SPIDER_MODULES = ['Scrapy_CQC_NYDL_SNCY_hangyebiaozhun.spiders']
NEWSPIDER_MODULE = 'Scrapy_CQC_NYDL_SNCY_hangyebiaozhun.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_CQC_NYDL_SNCY_hangyebiaozhun.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_CQC_NYDL_SNCY_hangyebiaozhun.pipelines.MongoDBPipeline': 300,
}
