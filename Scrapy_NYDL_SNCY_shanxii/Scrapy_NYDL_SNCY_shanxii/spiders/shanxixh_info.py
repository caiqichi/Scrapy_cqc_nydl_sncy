...
class ShanxixhInfoSpider(scrapy.Spider):
    name = 'shanxixh_info'
    # allowed_domains = ['w']
    ...
    def start_requests(self):
        for i in range(1,2):
            url = "http://www.sxsslgcxh.com/index/ListPageLaypage?Nowstype=1&page={0}&pagesize=20".format(i)
            yield scrapy.Request(url=url,callback=self.parse,dont_filter=True)
        url1 = "http://www.sxsslgcxh.com/index/ListPageLaypage?page=1&Nowstype=2&pagesize=20"
    ...
    def detail_parse(self, response):
        # try:
        #     source = response.xpath('//div[@class="location"]/h4[@id="headt2"]/text()').extract_first()
        ...
        try:
            ...
            if source.replace("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", "") is not None and len(
                    source.replace("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", "").strip()) != 0:
...
if __name__ == '__main__':
    os.system('scrapy crawl shanxixh_info')  ##改下爬虫名
