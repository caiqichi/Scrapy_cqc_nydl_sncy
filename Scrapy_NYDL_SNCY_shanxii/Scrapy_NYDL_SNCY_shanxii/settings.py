# Scrapy settings for Scrapy_NYDL_SNCY_shanxii project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_shanxii'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_shanxii.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_shanxii.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_shanxii.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_shanxii.pipelines.MongoDBPipeline': 300,
}
