# Scrapy settings for Scrapy_NYDL_SNCY_henan project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_henan'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_henan.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_henan.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_henan.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_henan.pipelines.MongoDBPipeline': 300,
}
