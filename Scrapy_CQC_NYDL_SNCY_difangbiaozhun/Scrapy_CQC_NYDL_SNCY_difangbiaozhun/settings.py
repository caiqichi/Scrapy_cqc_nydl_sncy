# Scrapy settings for Scrapy_CQC_NYDL_SNCY_difangbiaozhun project
#
...
BOT_NAME = 'Scrapy_CQC_NYDL_SNCY_difangbiaozhun'

SPIDER_MODULES = ['Scrapy_CQC_NYDL_SNCY_difangbiaozhun.spiders']
NEWSPIDER_MODULE = 'Scrapy_CQC_NYDL_SNCY_difangbiaozhun.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_CQC_NYDL_SNCY_difangbiaozhun.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_CQC_NYDL_SNCY_difangbiaozhun.pipelines.MongoDBPipeline': 300,
}
