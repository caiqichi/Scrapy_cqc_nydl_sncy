# Scrapy settings for Scrapy_NYDL_SNCY_yunan project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_yunan'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_yunan.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_yunan.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_yunan.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_yunan.pipelines.MongoDBPipeline': 300,
}
