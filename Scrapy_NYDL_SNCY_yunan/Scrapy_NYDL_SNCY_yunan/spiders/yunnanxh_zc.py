...
class YunanxhZcSpider(scrapy.Spider):
    name = 'yunanxh_zc'
    # allowed_domains = ['w']
    start_urls = ['http://www.ynslxh.com/index.php?s=/List/index/cid/12.html',
                  ]
    ...
    def parse(self, response):
        ...
        #     next_page = "http://www.ynslxh.com/index.php?s=/List/index/cid/12/p/{0}.html".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl yunanxh_zc')  ##改下爬虫名
