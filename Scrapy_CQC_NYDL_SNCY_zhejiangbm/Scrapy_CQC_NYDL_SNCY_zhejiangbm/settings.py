# Scrapy settings for Scrapy_CQC_NYDL_SNCY_zhejiangbm project
#
...
BOT_NAME = 'Scrapy_CQC_NYDL_SNCY_zhejiangbm'

SPIDER_MODULES = ['Scrapy_CQC_NYDL_SNCY_zhejiangbm.spiders']
NEWSPIDER_MODULE = 'Scrapy_CQC_NYDL_SNCY_zhejiangbm.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'Scrapy_CQC_NYDL_SNCY_zhejiangbm (+http://www.yourdomain.com)'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_CQC_NYDL_SNCY_zhejiangbm.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_CQC_NYDL_SNCY_zhejiangbm.pipelines.MongoDBPipeline': 300,
}
