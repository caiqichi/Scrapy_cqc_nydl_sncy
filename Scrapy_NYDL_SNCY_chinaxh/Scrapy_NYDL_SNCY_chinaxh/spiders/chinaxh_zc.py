...
class ChinaxhxhZcSpider(scrapy.Spider):
    name = 'chinaxhxh_zc'
    # allowed_domains = ['w']
    start_urls = ['http://www.hydropower.org.cn/showNewsList.asp?bigId=1&smlId=3',
                  ]
    ...
    def parse(self, response):
        ...
        #     next_page = "http://www.hydropower.org.cn/showNewsList.asp?smlId=3&bigId=1&page={0}".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl chinaxhxh_zc')  ##改下爬虫名
