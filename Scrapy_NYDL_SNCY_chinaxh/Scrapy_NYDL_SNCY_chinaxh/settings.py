# Scrapy settings for Scrapy_NYDL_SNCY_chinaxh project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_chinaxh'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_chinaxh.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_chinaxh.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_chinaxh.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_chinaxh.pipelines.MongoDBPipeline': 300,
}
