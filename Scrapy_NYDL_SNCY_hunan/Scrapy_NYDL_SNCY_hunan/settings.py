# Scrapy settings for Scrapy_NYDL_SNCY_hunan project
#
...
BOT_NAME = 'Scrapy_NYDL_SNCY_hunan'

SPIDER_MODULES = ['Scrapy_NYDL_SNCY_hunan.spiders']
NEWSPIDER_MODULE = 'Scrapy_NYDL_SNCY_hunan.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Scrapy_NYDL_SNCY_hunan.middlewares.ScrapyproxyMiddleware': 823,  # 建立爬虫项目时就有的
...
ITEM_PIPELINES = {
   'Scrapy_NYDL_SNCY_hunan.pipelines.MongoDBPipeline': 300,
}
