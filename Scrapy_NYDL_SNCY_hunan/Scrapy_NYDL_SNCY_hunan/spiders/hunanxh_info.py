...
class HunanxhInfoSpider(scrapy.Spider):
    name = 'hunanxh_info'
    # allowed_domains = ['w']
    ...
    def start_requests(self):
        ...
        for j in range(1, 2):
            ...
            url = "http://www.hnslxh.com/webucation/api/website/paper/getPaperList"
            yield scrapy.Request(url=url, callback=self.parse, dont_filter=True, body=json.dumps(data2), method="POST",
                                 )
    ...
    def parse(self, response):
        ...
        for i in list:
            ...
            id = i["id"]
            content_url = "http://www.hnslxh.com/webucation/api/website/paper/getPaper?timestamp=1624957316855"
            data1 = {
                "paperId":str(id),
            }
            headers1 = {
...
if __name__ == '__main__':
    os.system('scrapy crawl hunanxh_info')  ##改下爬虫名
